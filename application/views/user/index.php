            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Pickup</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php
                                $id = $this->session->userdata('id_user');
                                $total = $this->ModelPickup->totalPickup($id);
                                echo $total;
                                ?> Pickup</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php
                                $id = $this->session->userdata('id_user');
                                $total = $this->ModelBooking->totalBooking($id);
                                echo $total;
                                ?> Booking</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">0 Transaksi</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php foreach ($total_trans as $t) : ?>
                                    <?= $t['jumlah']; ?> Transaksi</div>
                        <?php endforeach; ?>
                        </div>
                        <div class="col-auto">
