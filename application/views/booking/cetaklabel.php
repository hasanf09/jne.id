    ...
    <div class="container-fluid">
        <div class="row" style="padding: 15px; text-transform:uppercase;">
            <div class="col-5" style="max-width: 600px !important; width: 600px; flex: 0 0 600px; border: 1px solid #333; padding-top: 10px; padding-bottom: 10px">
                <div class="row">
                   <div class="col-4" style="border-right: 1px solid #333"><img src="<?= base_url('assets/'); ?>img/logo/logo jne.png" height="50px" alt=""></div>
                    <div class="col-5 text-center" style="border-right: 1px solid #333">
                        <?php foreach ($booking as $b) { ?>
                            <h1 style="font-size: 25px;" class="my-2"><?= $b['kode_booking']; ?></h1>
                    </div>
                    <div class="col-3 text-center">
                        <h1 style="font-size: 25px;" class="my-2"><?= $b['layanan']; ?></h1>
                    </div>
                </div>
                <hr style="margin-top: 5px; border-style: dashed; border-color: #333">
                <div class="row">
                    <div class="col-2" style="text-transform: none;">Kepada</div>
                    <div class="col-10">
                ...
                <div class="row">
                    <div class="col-2" style="text-transform: none;">Dari</div>
                    <div class="col-10">
                ...
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-3">
                        <strong><?= $b['isi_paket']; ?></strong>
                    </div>
                    <div class="col-7">
                        <strong><?= $b['berat']; ?> KG </strong>
                    </div>
                </div>
                <div style="margin: 8px 0"></div>
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-3" style="text-transform: none;">
                        Biaya Kirim: <br>
                        <strong style="font-size: 20px">Rp.<?= number_format($b['ongkir'], '0', ',', '.'); ?></strong>
                    </div>
                </div>
            <?php } ?>
            ...
            <div class="row">
                <div class="col-12">
                    <p style="font-size: 12px; margin-bottom: 10px; margin-top: 10px; text-transform: none;"></p>
                </div>
            </div>
            </div>
